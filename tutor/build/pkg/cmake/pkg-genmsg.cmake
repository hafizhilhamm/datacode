...
set(MSG_I_FLAGS "-Ipkg:/home/hafizh/tutorros/tutor/src/pkg/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/hafizh/tutorros/tutor/src/pkg/msg/Num.msg" NAME_WE)
add_custom_target(_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "pkg" "/home/hafizh/tutorros/tutor/src/pkg/msg/Num.msg" ""
)

get_filename_component(_filename "/home/hafizh/tutorros/tutor/src/pkg/srv/pertambahan.srv" NAME_WE)
add_custom_target(_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "pkg" "/home/hafizh/tutorros/tutor/src/pkg/srv/pertambahan.srv" ""
)
...
_generate_msg_cpp(pkg
  "/home/hafizh/tutorros/tutor/src/pkg/msg/Num.msg"
  "${MSG_I_FLAGS}"
  ""
...
_generate_srv_cpp(pkg
  "/home/hafizh/tutorros/tutor/src/pkg/srv/pertambahan.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/pkg
)
